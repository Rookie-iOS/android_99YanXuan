...
public abstract class BaseLinearTemplateView extends LinearLayout
    ...
    public BaseLinearTemplateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public BaseLinearTemplateView(Context context, AttributeSet attrs, int defStyleAttr) {
